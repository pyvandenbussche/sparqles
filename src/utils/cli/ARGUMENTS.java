...
public class ARGUMENTS {
	...
	public static final Option OPTION_PROP_FILE = createOption("property file", 1, "SPARQLES (additional) property file", PARAM_PROP_FILE[SHORT_ARG], PARAM_PROP_FILE[LONG_ARG],false);
