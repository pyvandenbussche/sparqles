...
public class Run extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static sparqles.core.performance.Run.Builder newBuilder() {
    return new sparqles.core.performance.Run.Builder();
  }
  
  /** Creates a new Run RecordBuilder by copying an existing Builder */
  public static sparqles.core.performance.Run.Builder newBuilder(sparqles.core.performance.Run.Builder other) {
    return new sparqles.core.performance.Run.Builder(other);
  }
  
  /** Creates a new Run RecordBuilder by copying an existing Run instance */
  public static sparqles.core.performance.Run.Builder newBuilder(sparqles.core.performance.Run other) {
    return new sparqles.core.performance.Run.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Run>
    ...
    private Builder() {
      super(sparqles.core.performance.Run.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(sparqles.core.performance.Run.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Run instance */
    private Builder(sparqles.core.performance.Run other) {
            super(sparqles.core.performance.Run.SCHEMA$);
    ...
    /** Sets the value of the 'frestout' field */
    public sparqles.core.performance.Run.Builder setFrestout(long value) {
    ...
    public sparqles.core.performance.Run.Builder clearFrestout() {
    ...
    /** Sets the value of the 'solutions' field */
    public sparqles.core.performance.Run.Builder setSolutions(int value) {
    ...
    public sparqles.core.performance.Run.Builder clearSolutions() {
    ...
    /** Sets the value of the 'inittime' field */
    public sparqles.core.performance.Run.Builder setInittime(long value) {
    ...
    public sparqles.core.performance.Run.Builder clearInittime() {
    ...
    /** Sets the value of the 'exectime' field */
    public sparqles.core.performance.Run.Builder setExectime(long value) {
    ...
    public sparqles.core.performance.Run.Builder clearExectime() {
    ...
    /** Sets the value of the 'closetime' field */
    public sparqles.core.performance.Run.Builder setClosetime(long value) {
    ...
    public sparqles.core.performance.Run.Builder clearClosetime() {
    ...
    /** Sets the value of the 'Exception' field */
    public sparqles.core.performance.Run.Builder setException(java.lang.CharSequence value) {
    ...
    public sparqles.core.performance.Run.Builder clearException() {
      Exception = null;
    ...
    /** Sets the value of the 'exectout' field */
    public sparqles.core.performance.Run.Builder setExectout(long value) {
    ...
    public sparqles.core.performance.Run.Builder clearExectout() {
