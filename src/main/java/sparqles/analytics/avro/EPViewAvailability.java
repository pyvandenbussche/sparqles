...
public class EPViewAvailability extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public sparqles.analytics.avro.EPViewAvailabilityData data;
   ...
   */
  public EPViewAvailability(java.lang.Boolean upNow, java.lang.Integer testRuns, java.lang.Double uptimeLast24h, java.lang.Double uptimeLast7d, java.lang.Double uptimeLast31d, java.lang.Double uptimeOverall, sparqles.analytics.avro.EPViewAvailabilityData data) {
    this.upNow = upNow;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: data = (sparqles.analytics.avro.EPViewAvailabilityData)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public sparqles.analytics.avro.EPViewAvailabilityData getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(sparqles.analytics.avro.EPViewAvailabilityData value) {
    this.data = value;
  }

  /** Creates a new EPViewAvailability RecordBuilder */
  public static sparqles.analytics.avro.EPViewAvailability.Builder newBuilder() {
    return new sparqles.analytics.avro.EPViewAvailability.Builder();
  }
  
  /** Creates a new EPViewAvailability RecordBuilder by copying an existing Builder */
  public static sparqles.analytics.avro.EPViewAvailability.Builder newBuilder(sparqles.analytics.avro.EPViewAvailability.Builder other) {
    return new sparqles.analytics.avro.EPViewAvailability.Builder(other);
  }
  
  /** Creates a new EPViewAvailability RecordBuilder by copying an existing EPViewAvailability instance */
  public static sparqles.analytics.avro.EPViewAvailability.Builder newBuilder(sparqles.analytics.avro.EPViewAvailability other) {
    return new sparqles.analytics.avro.EPViewAvailability.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPViewAvailability>
    ...
    private sparqles.analytics.avro.EPViewAvailabilityData data;

    /** Creates a new Builder */
    private Builder() {
      super(sparqles.analytics.avro.EPViewAvailability.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(sparqles.analytics.avro.EPViewAvailability.Builder other) {
      super(other);
    ...
    private Builder(sparqles.analytics.avro.EPViewAvailability other) {
            super(sparqles.analytics.avro.EPViewAvailability.SCHEMA$);
      if (isValidValue(fields()[0], other.upNow)) {
        this.upNow = data().deepCopy(fields()[0].schema(), other.upNow);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'upNow' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setUpNow(boolean value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearUpNow() {
    ...
    /** Sets the value of the 'testRuns' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setTestRuns(int value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearTestRuns() {
    ...
    /** Sets the value of the 'uptimeLast24h' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setUptimeLast24h(double value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearUptimeLast24h() {
    ...
    /** Sets the value of the 'uptimeLast7d' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setUptimeLast7d(double value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearUptimeLast7d() {
    ...
    /** Sets the value of the 'uptimeLast31d' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setUptimeLast31d(double value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearUptimeLast31d() {
    ...
    /** Sets the value of the 'uptimeOverall' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setUptimeOverall(double value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearUptimeOverall() {
    ...
    /** Sets the value of the 'data' field */
    public sparqles.analytics.avro.EPViewAvailability.Builder setData(sparqles.analytics.avro.EPViewAvailabilityData value) {
    ...
    public sparqles.analytics.avro.EPViewAvailability.Builder clearData() {
      data = null;
    ...
    public EPViewAvailability build() {
      try {
        ...
        record.data = fieldSetFlags()[6] ? this.data : (sparqles.analytics.avro.EPViewAvailabilityData) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
