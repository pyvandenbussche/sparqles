...
public class EPViewAvailabilityData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static sparqles.analytics.avro.EPViewAvailabilityData.Builder newBuilder() {
    return new sparqles.analytics.avro.EPViewAvailabilityData.Builder();
  }
  
  /** Creates a new EPViewAvailabilityData RecordBuilder by copying an existing Builder */
  public static sparqles.analytics.avro.EPViewAvailabilityData.Builder newBuilder(sparqles.analytics.avro.EPViewAvailabilityData.Builder other) {
    return new sparqles.analytics.avro.EPViewAvailabilityData.Builder(other);
  }
  
  /** Creates a new EPViewAvailabilityData RecordBuilder by copying an existing EPViewAvailabilityData instance */
  public static sparqles.analytics.avro.EPViewAvailabilityData.Builder newBuilder(sparqles.analytics.avro.EPViewAvailabilityData other) {
    return new sparqles.analytics.avro.EPViewAvailabilityData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPViewAvailabilityData>
    ...
    private Builder() {
      super(sparqles.analytics.avro.EPViewAvailabilityData.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(sparqles.analytics.avro.EPViewAvailabilityData.Builder other) {
      super(other);
    ...
    private Builder(sparqles.analytics.avro.EPViewAvailabilityData other) {
            super(sparqles.analytics.avro.EPViewAvailabilityData.SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'key' field */
    public sparqles.analytics.avro.EPViewAvailabilityData.Builder setKey(java.lang.CharSequence value) {
    ...
    public sparqles.analytics.avro.EPViewAvailabilityData.Builder clearKey() {
      key = null;
    ...
    public sparqles.analytics.avro.EPViewAvailabilityData.Builder clearValues() {
      values = null;
