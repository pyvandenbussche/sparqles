...
public class EPViewPerformanceDataValues extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static sparqles.analytics.avro.EPViewPerformanceDataValues.Builder newBuilder(sparqles.analytics.avro.EPViewPerformanceDataValues.Builder other) {
    return new sparqles.analytics.avro.EPViewPerformanceDataValues.Builder(other);
  }
  
  /** Creates a new EPViewPerformanceDataValues RecordBuilder by copying an existing EPViewPerformanceDataValues instance */
  public static sparqles.analytics.avro.EPViewPerformanceDataValues.Builder newBuilder(sparqles.analytics.avro.EPViewPerformanceDataValues other) {
    return new sparqles.analytics.avro.EPViewPerformanceDataValues.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EPViewPerformanceDataValues>
    ...
    private Builder() {
      super(sparqles.analytics.avro.EPViewPerformanceDataValues.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(sparqles.analytics.avro.EPViewPerformanceDataValues.Builder other) {
      super(other);
    ...
    private Builder(sparqles.analytics.avro.EPViewPerformanceDataValues other) {
            super(sparqles.analytics.avro.EPViewPerformanceDataValues.SCHEMA$);
      if (isValidValue(fields()[0], other.label)) {
        this.label = data().deepCopy(fields()[0].schema(), other.label);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'label' field */
    public sparqles.analytics.avro.EPViewPerformanceDataValues.Builder setLabel(java.lang.CharSequence value) {
    ...
    public sparqles.analytics.avro.EPViewPerformanceDataValues.Builder clearLabel() {
      label = null;
    ...
    /** Sets the value of the 'value' field */
    public sparqles.analytics.avro.EPViewPerformanceDataValues.Builder setValue(double value) {
    ...
    public sparqles.analytics.avro.EPViewPerformanceDataValues.Builder clearValue() {
