...
public class AvailabilityPage extends DimensionPage {

	public AvailabilityPage(ICom com){
		super(com,"Availability","To assess the reliability of SPARQL Endpoints, we test hourly (by default) " +
