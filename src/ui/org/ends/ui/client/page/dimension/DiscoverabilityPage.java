...
public class DiscoverabilityPage extends DimensionPage {

	public DiscoverabilityPage(ICom com){
		super(com,"Discoverability","To assess the reliability of SPARQL Endpoints, we test hourly (by default) " +
