...
public class InteroperabilityPage extends DimensionPage {

	public InteroperabilityPage(ICom com){
		super(com,"Interoperability","To assess the reliability of SPARQL Endpoints, we test hourly (by default) " +
