...
public class VoidResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"VoidResult\",\"namespace\":\"core.discovery\",\"fields\":[{\"name\":\"voidFile\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"Exception\",\"type\":[\"string\",\"null\"]}]}");
  ...
  public static core.discovery.VoidResult.Builder newBuilder() {
    return new core.discovery.VoidResult.Builder();
  }
  
  /** Creates a new VoidResult RecordBuilder by copying an existing Builder */
  public static core.discovery.VoidResult.Builder newBuilder(core.discovery.VoidResult.Builder other) {
    return new core.discovery.VoidResult.Builder(other);
  }
  
  /** Creates a new VoidResult RecordBuilder by copying an existing VoidResult instance */
  public static core.discovery.VoidResult.Builder newBuilder(core.discovery.VoidResult other) {
    return new core.discovery.VoidResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VoidResult>
    ...
    private Builder() {
      super(core.discovery.VoidResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.discovery.VoidResult.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing VoidResult instance */
    private Builder(core.discovery.VoidResult other) {
            super(core.discovery.VoidResult.SCHEMA$);
    ...
    /** Sets the value of the 'voidFile' field */
    public core.discovery.VoidResult.Builder setVoidFile(java.util.List<java.lang.CharSequence> value) {
    ...
    public core.discovery.VoidResult.Builder clearVoidFile() {
      voidFile = null;
    ...
    /** Sets the value of the 'Exception' field */
    public core.discovery.VoidResult.Builder setException(java.lang.CharSequence value) {
    ...
    public core.discovery.VoidResult.Builder clearException() {
      Exception = null;
