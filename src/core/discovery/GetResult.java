...
public class GetResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static core.discovery.GetResult.Builder newBuilder() {
    return new core.discovery.GetResult.Builder();
  }
  
  /** Creates a new GetResult RecordBuilder by copying an existing Builder */
  public static core.discovery.GetResult.Builder newBuilder(core.discovery.GetResult.Builder other) {
    return new core.discovery.GetResult.Builder(other);
  }
  
  /** Creates a new GetResult RecordBuilder by copying an existing GetResult instance */
  public static core.discovery.GetResult.Builder newBuilder(core.discovery.GetResult other) {
    return new core.discovery.GetResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GetResult>
    ...
    private Builder() {
      super(core.discovery.GetResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.discovery.GetResult.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing GetResult instance */
    private Builder(core.discovery.GetResult other) {
            super(core.discovery.GetResult.SCHEMA$);
    ...
    /** Sets the value of the 'ResponseType' field */
    public core.discovery.GetResult.Builder setResponseType(java.lang.CharSequence value) {
    ...
    public core.discovery.GetResult.Builder clearResponseType() {
      ResponseType = null;
    ...
    /** Sets the value of the 'ResponseCode' field */
    public core.discovery.GetResult.Builder setResponseCode(java.lang.CharSequence value) {
    ...
    public core.discovery.GetResult.Builder clearResponseCode() {
      ResponseCode = null;
    ...
    /** Sets the value of the 'ResponseServer' field */
    public core.discovery.GetResult.Builder setResponseServer(java.lang.CharSequence value) {
    ...
    public core.discovery.GetResult.Builder clearResponseServer() {
      ResponseServer = null;
    ...
    /** Sets the value of the 'ResponseLink' field */
    public core.discovery.GetResult.Builder setResponseLink(java.lang.CharSequence value) {
    ...
    public core.discovery.GetResult.Builder clearResponseLink() {
      ResponseLink = null;
    ...
    /** Sets the value of the 'SPARQLDESCterms' field */
    public core.discovery.GetResult.Builder setSPARQLDESCterms(long value) {
    ...
    public core.discovery.GetResult.Builder clearSPARQLDESCterms() {
    ...
    /** Sets the value of the 'Exception' field */
    public core.discovery.GetResult.Builder setException(java.lang.CharSequence value) {
    ...
    public core.discovery.GetResult.Builder clearException() {
      Exception = null;
    ...
    /** Sets the value of the 'VOIDterms' field */
    public core.discovery.GetResult.Builder setVOIDterms(long value) {
    ...
    public core.discovery.GetResult.Builder clearVOIDterms() {
    ...
    /** Sets the value of the 'SPARQLDESCpreds' field */
    public core.discovery.GetResult.Builder setSPARQLDESCpreds(java.util.Map<java.lang.CharSequence,java.lang.Object> value) {
    ...
    public core.discovery.GetResult.Builder clearSPARQLDESCpreds() {
    ...
    /** Sets the value of the 'voiDpreds' field */
    public core.discovery.GetResult.Builder setVoiDpreds(java.util.Map<java.lang.CharSequence,java.lang.Object> value) {
    ...
    public core.discovery.GetResult.Builder clearVoiDpreds() {
      voiDpreds = null;
