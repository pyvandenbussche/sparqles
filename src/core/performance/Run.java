...
public class Run extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static core.performance.Run.Builder newBuilder() {
    return new core.performance.Run.Builder();
  }
  
  /** Creates a new Run RecordBuilder by copying an existing Builder */
  public static core.performance.Run.Builder newBuilder(core.performance.Run.Builder other) {
    return new core.performance.Run.Builder(other);
  }
  
  /** Creates a new Run RecordBuilder by copying an existing Run instance */
  public static core.performance.Run.Builder newBuilder(core.performance.Run other) {
    return new core.performance.Run.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Run>
    ...
    private Builder() {
      super(core.performance.Run.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.performance.Run.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Run instance */
    private Builder(core.performance.Run other) {
            super(core.performance.Run.SCHEMA$);
    ...
    /** Sets the value of the 'frestout' field */
    public core.performance.Run.Builder setFrestout(long value) {
    ...
    public core.performance.Run.Builder clearFrestout() {
    ...
    /** Sets the value of the 'solutions' field */
    public core.performance.Run.Builder setSolutions(int value) {
    ...
    public core.performance.Run.Builder clearSolutions() {
    ...
    /** Sets the value of the 'inittime' field */
    public core.performance.Run.Builder setInittime(long value) {
    ...
    public core.performance.Run.Builder clearInittime() {
    ...
    /** Sets the value of the 'exectime' field */
    public core.performance.Run.Builder setExectime(long value) {
    ...
    public core.performance.Run.Builder clearExectime() {
    ...
    /** Sets the value of the 'closetime' field */
    public core.performance.Run.Builder setClosetime(long value) {
    ...
    public core.performance.Run.Builder clearClosetime() {
