...
public class AResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static core.availability.AResult.Builder newBuilder() {
    return new core.availability.AResult.Builder();
  }
  
  /** Creates a new AResult RecordBuilder by copying an existing Builder */
  public static core.availability.AResult.Builder newBuilder(core.availability.AResult.Builder other) {
    return new core.availability.AResult.Builder(other);
  }
  
  /** Creates a new AResult RecordBuilder by copying an existing AResult instance */
  public static core.availability.AResult.Builder newBuilder(core.availability.AResult other) {
    return new core.availability.AResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AResult>
    ...
    private Builder() {
      super(core.availability.AResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.availability.AResult.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing AResult instance */
    private Builder(core.availability.AResult other) {
            super(core.availability.AResult.SCHEMA$);
    ...
    /** Sets the value of the 'endpointResult' field */
    public core.availability.AResult.Builder setEndpointResult(core.EndpointResult value) {
    ...
    public core.availability.AResult.Builder clearEndpointResult() {
      endpointResult = null;
    ...
    /** Sets the value of the 'responseTime' field */
    public core.availability.AResult.Builder setResponseTime(long value) {
    ...
    public core.availability.AResult.Builder clearResponseTime() {
    ...
    /** Sets the value of the 'isAvailable' field */
    public core.availability.AResult.Builder setIsAvailable(boolean value) {
    ...
    public core.availability.AResult.Builder clearIsAvailable() {
    ...
    /** Sets the value of the 'isPrivate' field */
    public core.availability.AResult.Builder setIsPrivate(boolean value) {
    ...
    public core.availability.AResult.Builder clearIsPrivate() {
