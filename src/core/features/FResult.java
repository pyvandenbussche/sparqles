...
public class FResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public FResult(core.EndpointResult endpointResult, java.util.Map<java.lang.CharSequence,core.features.FSingleResult> results) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: results = (java.util.Map<java.lang.CharSequence,core.features.FSingleResult>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public java.util.Map<java.lang.CharSequence,core.features.FSingleResult> getResults() {
    return results;
  }
   ...
   * @param value the value to set.
   */
  public void setResults(java.util.Map<java.lang.CharSequence,core.features.FSingleResult> value) {
    this.results = value;
  }

  /** Creates a new FResult RecordBuilder */
  public static core.features.FResult.Builder newBuilder() {
    return new core.features.FResult.Builder();
  }
  
  /** Creates a new FResult RecordBuilder by copying an existing Builder */
  public static core.features.FResult.Builder newBuilder(core.features.FResult.Builder other) {
    return new core.features.FResult.Builder(other);
  }
  
  /** Creates a new FResult RecordBuilder by copying an existing FResult instance */
  public static core.features.FResult.Builder newBuilder(core.features.FResult other) {
    return new core.features.FResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FResult>
    ...
    private java.util.Map<java.lang.CharSequence,core.features.FSingleResult> results;

    /** Creates a new Builder */
    private Builder() {
      super(core.features.FResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.features.FResult.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing FResult instance */
    private Builder(core.features.FResult other) {
            super(core.features.FResult.SCHEMA$);
    ...
    /** Sets the value of the 'endpointResult' field */
    public core.features.FResult.Builder setEndpointResult(core.EndpointResult value) {
    ...
    public core.features.FResult.Builder clearEndpointResult() {
      endpointResult = null;
    ...
    /** Sets the value of the 'results' field */
    public core.features.FResult.Builder setResults(java.util.Map<java.lang.CharSequence,core.features.FSingleResult> value) {
    ...
    public core.features.FResult.Builder clearResults() {
      results = null;
    ...
    public FResult build() {
      try {
        ...
        record.results = fieldSetFlags()[1] ? this.results : (java.util.Map<java.lang.CharSequence,core.features.FSingleResult>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
