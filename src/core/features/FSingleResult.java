...
public class FSingleResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public core.performance.Run run;
   ...
   */
  public FSingleResult(java.lang.CharSequence query, core.performance.Run run) {
    this.query = query;
    this.run = run;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: run = (core.performance.Run)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public core.performance.Run getRun() {
    return run;
  }
   ...
   * @param value the value to set.
   */
  public void setRun(core.performance.Run value) {
    this.run = value;
  }

  /** Creates a new FSingleResult RecordBuilder */
  public static core.features.FSingleResult.Builder newBuilder() {
    return new core.features.FSingleResult.Builder();
  }
  
  /** Creates a new FSingleResult RecordBuilder by copying an existing Builder */
  public static core.features.FSingleResult.Builder newBuilder(core.features.FSingleResult.Builder other) {
    return new core.features.FSingleResult.Builder(other);
  }
  
  /** Creates a new FSingleResult RecordBuilder by copying an existing FSingleResult instance */
  public static core.features.FSingleResult.Builder newBuilder(core.features.FSingleResult other) {
    return new core.features.FSingleResult.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FSingleResult>
    ...
    private core.performance.Run run;

    /** Creates a new Builder */
    private Builder() {
      super(core.features.FSingleResult.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(core.features.FSingleResult.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing FSingleResult instance */
    private Builder(core.features.FSingleResult other) {
            super(core.features.FSingleResult.SCHEMA$);
    ...
    /** Sets the value of the 'query' field */
    public core.features.FSingleResult.Builder setQuery(java.lang.CharSequence value) {
    ...
    public core.features.FSingleResult.Builder clearQuery() {
      query = null;
    ...
    /** Sets the value of the 'run' field */
    public core.features.FSingleResult.Builder setRun(core.performance.Run value) {
    ...
    public core.features.FSingleResult.Builder clearRun() {
      run = null;
    ...
    public FSingleResult build() {
      try {
        ...
        record.run = fieldSetFlags()[1] ? this.run : (core.performance.Run) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {
